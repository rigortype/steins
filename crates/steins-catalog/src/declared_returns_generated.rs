...
pub(crate) static DECLARED_RETURNS: &[(&str, &str)] = &[
    ...
    ("array_count_values", "array<positive-int>"),
    ("array_diff", "array"),
    ...
    ("date_format", "string"),
    ("date_get_last_errors", "false|array{error_count: positive-int|0, errors: list<string>, warning_count: positive-int|0, warnings: list<string>}"),
    ...
    ("file_put_contents", "positive-int|0|false"),
    ("fileatime", "int|false"),
    ("filectime", "int|false"),
    ("filegroup", "int|false"),
    ("fileinode", "int|false"),
    ...
    ("fnmatch", "bool"),
    ("fprintf", "int"),
    ("fputcsv", "positive-int|0|false"),
    ("fputs", "positive-int|0|false"),
    ("fread", "string|false"),
    ("frenchtojd", "int"),
    ("fseek", "0|-1"),
    ("fstat", "false|array"),
    ...
    ("func_num_args", "positive-int|0"),
    ("function_exists", "bool"),
    ("fwrite", "positive-int|0|false"),
    ...
    ("getimagesize", "false|array{positive-int|0, positive-int|0, int, string, bits?: int, channels?: int, mime: string}"),
    ("getimagesizefromstring", "false|array{positive-int|0, positive-int|0, int, string, bits?: int, channels?: int, mime: string}"),
    ...
    ("iconv_strlen", "positive-int|0|false"),
    ...
    ("imagechar", "bool"),
    ("imagecharup", "bool"),
    ("imagecolorallocate", "non-negative-int|false"),
    ("imagecolorallocatealpha", "non-negative-int|false"),
    ("imagecolorat", "non-negative-int|false"),
    ("imagecolorclosest", "non-negative-int"),
    ("imagecolorclosestalpha", "non-negative-int"),
    ("imagecolorclosesthwb", "non-negative-int"),
    ("imagecolordeallocate", "bool"),
    ("imagecolormatch", "bool"),
    ("imagecolorresolve", "non-negative-int"),
    ("imagecolorresolvealpha", "non-negative-int"),
    ...
    ("imagestring", "bool"),
    ("imagestringup", "bool"),
    ("imagesx", "positive-int"),
    ("imagesy", "positive-int"),
    ...
    ("is_writable", "bool"),
    ("is_writeable", "bool"),
    ("iterator_apply", "positive-int|0"),
    ("iterator_count", "positive-int|0"),
    ...
    ("mb_stripos", "positive-int|0|false"),
    ("mb_stristr", "string|false"),
    ("mb_strlen", "positive-int|0"),
    ("mb_strpos", "positive-int|0|false"),
    ("mb_strrchr", "string|false"),
    ("mb_strrichr", "string|false"),
    ("mb_strripos", "positive-int|0|false"),
    ("mb_strrpos", "positive-int|0|false"),
    ("mb_strstr", "string|false"),
    ("mb_strtolower", "lowercase-string"),
    ("mb_strtoupper", "uppercase-string"),
    ("mb_strwidth", "positive-int|0"),
    ("mb_substr", "string"),
    ("mb_substr_count", "positive-int|0"),
    ("mb_ucfirst", "string"),
    ("memory_get_peak_usage", "positive-int"),
    ("memory_get_usage", "positive-int"),
    ("metaphone", "string"),
    ("method_exists", "bool"),
    ("mhash", "string|false"),
    ("mhash_count", "int"),
    ...
    ("mt_getrandmax", "int"),
    ("mt_rand", "int"),
    ("mysqli_affected_rows", "int<-1, 9223372036854775807>|numeric-string"),
    ...
    ("mysqli_num_rows", "non-negative-int|numeric-string"),
    ("mysqli_options", "bool"),
    ("mysqli_ping", "bool"),
    ...
    ("mysqli_stmt_affected_rows", "int<-1, 9223372036854775807>|numeric-string"),
    ...
    ("mysqli_stmt_field_count", "positive-int|0"),
    ...
    ("mysqli_stmt_param_count", "positive-int|0"),
    ...
    ("readfile", "positive-int|0|false"),
    ("readgzfile", "positive-int|0|false"),
    ...
    ("session_get_cookie_params", "array{domain: string, httponly: bool, lifetime: positive-int|0, partitioned: bool, path: non-falsy-string, samesite: 'Lax'|'None'|'Strict'|'lax'|'none'|'strict', secure: bool}"),
    ...
    ("time", "positive-int"),
    ("time_nanosleep", "bool|array{nanoseconds: positive-int|0, seconds: positive-int|0}"),
