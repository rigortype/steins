...
//    2083  rows the declared-contract arm lane cannot carry, of which
//     388    shaped arrays / lists
//     620    objects / class names / callable / resource
//      47  rows the arm-wise engine countersign refuses
//    2207  names the pinned engine does not know as functions
//    1358  ADMITTED (the table below), of which
//     439    RICHER than a single-base envelope (the issue-#79 reach)
//
