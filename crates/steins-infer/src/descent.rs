...
use steins_syntax::{
    ArgValue, CallExpr, Callee, NameRef, NamedArg, Param, Receiver, RefKind, Scope, ScopeOwner,
    StaticClass, StmtKind,
};
...
use crate::heap::{argument_heap_object, copy_for_descent, object_binding_key, simple_class};
