...
| [phpdoc-effects-interop.md](phpdoc-effects-interop.md) | Interop envelopes: effect labels on the PHPStan purity tags — grammar, semantics, upstream compatibility (designed, ADR-0082). |
