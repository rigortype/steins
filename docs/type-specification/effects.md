...
| a `global` or `static` declaration, a superglobal access, a static property access, or an instance property write | **no** effect yet, but exhaustiveness is tainted — interim, until the ADR-0055 labels are inferred (ADR-0055 amendment of 2026-09-26) |
