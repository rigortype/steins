...
// then issue #354's five, its four aliases, and wave 2). On the full lane every
// one of the 63 folds, so what a narrow engine would decline is invisible here.
assert(boot.fold_total === 63 && boot.fold_portable === 50, "the catalog's own counts travel");
